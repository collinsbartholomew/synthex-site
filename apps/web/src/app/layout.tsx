...
export const metadata: Metadata = {
  ...
  title: {
    default: "Synthex Site | Living Interface",
    template: "%s | Synthex Site",
  },
  description:
    "AI-native personal platform — cinematic design, adaptive interface, and intelligent systems.",
  openGraph: {
    type: "website",
    siteName: "Synthex Site",
    locale: "zh_CN",
    alternateLocale: "en_US",
    url: SITE_URL,
    title: "Synthex Site | Living Interface",
    description:
      "AI-native personal platform — cinematic design, adaptive interface, and intelligent systems.",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Synthex Site – Living Interface" }],
  },
  twitter: {
